  ...
  if(conf.is_open())
  {
    while(!conf.eof())
    {
      ...
      if(line.find('=') != string::npos)
      {
        ...
        } else if(set=="conwhich components/parts have the highest priority for developing unit tests (based on quality of the
components, difficulty of developing unit tests, ...)trolstartspeed")
        {
